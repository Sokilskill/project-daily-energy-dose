...
`,dt=M.svg`
  ...
  height: 18px;
  stroke: ${n=>n.color};
`;function nr({setParams:n,initialCategory:t,initialRecommended:i}){const[o,e]=p.useState(""),[a,u]=p.useState(""),[l,r]=p.useState(""),[s,c]=p.useState(""),[d,m]=p.useState(!0);p.useEffect(()=>{if(d){m(!1);return}n({search:l,category:o,groupBloodNotAllowed:a})},[l,a,o]);const h=C=>{e(C.value)},v=C=>{u(C.value)},b=()=>o?t.find(C=>C.value===C):"",f=()=>a?i.find(C=>C.value===a):"",g=C=>{c(C.currentTarget.value)},x=()=>{e(""),u(""),r(""),c("")},y=C=>{C.preventDefault(),r(s)};return E.jsxs(er,{children:[E.jsxs(Qo,{children:[E.jsxs(Jo,{onSubmit:y,children:[E.jsx(tr,{type:"text",name:"request",pattern:"^[a-zA-Zа-яА-Я]+(([' \\-][a-zA-Zа-яА-Я ])?[a-zA-Zа-яА-Я]*)*$",placeholder:"Search",value:s,onChange:g,required:!0,autoComplete:"off"}),E.jsx(ct,{right:"14px",type:"submit",children:E.jsx(dt,{color:"#EFEDE8",children:E.jsx("use",{href:de+"#icon-search"})})})]}),(s||a||o)&&E.jsx(ct,{right:"40px",onClick:x,children:E.jsx(dt,{color:"#E6533C",children:E.jsx("use",{href:de+"#icon-clear"})})})]}),E.jsx(lt,{onChange:h,value:b(),options:t,classNamePrefix:"custom-select",className:"custom-select-container",placeholder:"Categories"}),E.jsx(lt,{onChange:v,value:f(),options:i,classNamePrefix:"custom-select-second",className:"custom-select-second-container",placeholder:"All"})]})}const ir=M.ul`
  width: 100%;
  height: 1268px;
  overflow-y: scroll;
  overflow-x: hidden;
