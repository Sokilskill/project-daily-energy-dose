import{A as qt,r as p,E as Kt,B as Xt,C as Zt,n as D,_ as w,x as Jt,j as g,s as oe,p as $,L as Qt,D as gt,w as en,F as tn,Q as nn,c as on,H as rn,I as Ne}from"./index-fba6f8a3.js";import{e as ie,a as vt,h as an,_ as un,b as sn,c as ln,d as cn,g as dn}from"./defineProperty-179e1ab7.js";import"./hoist-non-react-statics.cjs-bc72caba.js";var S=function(t,i){var o=arguments;if(i==null||!qt.call(i,"css"))return p.createElement.apply(void 0,o);var e=o.length,a=new Array(e);a[0]=Kt,a[1]=Xt(t,i);for(var u=2;u<e;u++)a[u]=o[u];return p.createElement.apply(null,a)};function Pe(){for(var n=arguments.length,t=new Array(n),i=0;i<n;i++)t[i]=arguments[i];return Zt(t)}var pn=function(){var t=Pe.apply(void 0,arguments),i="animation-"+t.name;return{name:i,styles:"@keyframes "+i+"{"+t.styles+"}",anim:1,toString:function(){return"_EMO_"+this.name+"_"+this.styles+"_EMO_"}}};const fn=D.section`
  width: 100%;
  height: 100vh;
  margin: 0 auto;
  padding-top: 40px;
...
`,dt=D.svg`
  ...
  height: 18px;
  stroke: ${n=>n.color};
`;function rr({setParams:n,initialCategory:t,initialRecommended:i}){const[o,e]=p.useState(""),[a,u]=p.useState(""),[l,r]=p.useState(""),[s,c]=p.useState(""),[d,h]=p.useState(!0);p.useEffect(()=>{if(d){h(!1);return}n({search:l,category:o,groupBloodNotAllowed:a})},[l,a,o]);const m=C=>{e(C.value)},v=C=>{u(C.value)},b=()=>o?t.find(C=>C.value===C):"",f=()=>a?i.find(C=>C.value===a):"",x=C=>{c(C.currentTarget.value)},E=()=>{r(""),c("")},F=C=>{C.preventDefault(),r(s)};return g.jsxs(ir,{children:[g.jsxs(nr,{children:[g.jsxs(tr,{onSubmit:F,children:[g.jsx(or,{type:"text",name:"request",pattern:"^[a-zA-Zа-яА-Я]+(([' \\-][a-zA-Zа-яА-Я ])?[a-zA-Zа-яА-Я]*)*$",placeholder:"Search",value:s,onChange:x,required:!0,autoComplete:"off"}),g.jsx(ct,{right:"14px",type:"submit",children:g.jsx(dt,{color:"#EFEDE8",children:g.jsx("use",{href:oe+"#icon-search"})})})]}),s&&g.jsx(ct,{right:"40px",onClick:E,children:g.jsx(dt,{color:"#E6533C",children:g.jsx("use",{href:oe+"#icon-clear"})})})]}),g.jsx(lt,{onChange:m,value:b(),options:t,classNamePrefix:"custom-select",className:"custom-select-container",placeholder:"Categories"}),g.jsx(lt,{onChange:v,value:f(),options:i,classNamePrefix:"custom-select-second",className:"custom-select-second-container",placeholder:"All"})]})}const ar=D.ul`
  width: 100%;
  height: 1268px;
  overflow-y: scroll;
  overflow-x: hidden;
...
`,_r=()=>{nn.warn("error",{theme:"dark"})};function Wr(n){let t=n.getDate(),i=n.getMonth()+1;const o=n.getFullYear();return t=t<10?`0${t}`:t,i=i<10?`0${i}`:i,`${o}-${i}-${t}`}const Gr=({onClose:n,open:t,title:i,calories:o,id:e})=>{const[a,u]=p.useState(!1),[l,r]=p.useState(0),[s,c]=p.useState(""),d=`${i[0].toUpperCase()+i.slice(1,111)}`,h=p.useCallback(b=>{b.key==="Escape"&&n()},[n]);p.useEffect(()=>(document.addEventListener("keydown",h),()=>{document.removeEventListener("keydown",h)}),[h]);const m=b=>{const f=Number(b.target.value)*o/100;f&&r(f),c(b.target.value)},v=async b=>{b.preventDefault();const f={date:Wr(new Date),productData:{productId:`${e}`,amount:Number(s)}};tn(f).then(x=>{u(!0)}).catch(x=>{_r()})};return g.jsx(g.Fragment,{children:g.jsxs(Ar,{onClick:n,children:[g.jsx(en,{}),a?g.jsx(Ir,{onClose:n,actualCalories:l}):g.jsxs(Mr,{onClick:b=>b.stopPropagation(),children:[g.jsx(Vr,{children:g.jsx(gt,{onClick:n,size:"22px"})}),g.jsxs(Lr,{name:"addProductForm",onSubmit:v,children:[g.jsxs(kr,{children:[g.jsx(Nr,{children:g.jsx(Ur,{children:d})}),g.jsxs(Br,{children:[g.jsx(Tr,{type:"text",value:s,onChange:m,required:!0,pattern:"[0-9]{1,5}",min:1}),g.jsx(jr,{children:"grams"})]}),g.jsxs(Pr,{children:["Calories: "," ",g.jsx(Rr,{children:l})]})]}),g.jsxs($r,{children:[g.jsx(Hr,{type:"submit",children:"Add to diary"}),g.jsx(zr,{type:"button",onClick:n,children:"Cancel"})]})]})]})]})})};let Ve;const Yr=()=>{window.screen.width<1440?Ve=!0:Ve=!1};Yr();function qr({productItem:n}){const[t,i]=p.useState(!1),o=()=>{i(!1),document.body.style.overflow="auto"},{weight:e,calories:a,category:u,title:l,groupBloodNotAllowed:r,_id:s}=n,c=2,d=()=>{if(l){const m=l[0].toUpperCase();let v;return Ve?(v=`${m+l.slice(1,19)}`,l.length>19?`${v}...`:v):(v=`${m+l.slice(1,24)}`,l.length>24?`${v}...`:v)}return""},h=()=>{if(u){const v=`${u[0].toUpperCase()+u.slice(1,10)}`;return u.length>10?`${v}...`:v}return""};return g.jsxs(g.Fragment,{children:[g.jsxs(sr,{children:[g.jsxs(lr,{children:[g.jsx(cr,{children:"DIET"}),g.jsxs(dr,{children:[r[c]?g.jsxs(g.Fragment,{children:[g.jsx(mt,{color:"#419B09"}),g.jsx(ht,{children:"Recommended"})]}):g.jsxs(g.Fragment,{children:[g.jsx(mt,{color:"#E9101D"}),g.jsx(ht,{children:"Not recommended"})]}),g.jsxs(pr,{onClick:()=>{i(!0),document.body.style.overflow="hidden"},children:["Add",g.jsx(fr,{children:g.jsx("use",{href:oe+"#icon-arrow"})})]})]})]}),g.jsxs(hr,{children:[g.jsx(mr,{children:g.jsx("use",{href:oe+"#icon-icon"})}),g.jsx(gr,{children:d()}),g.jsxs(vr,{children:[g.jsxs(Oe,{children:["Calories: ",g.jsxs(De,{children:[" ",a]})]}),g.jsxs(Oe,{children:["Category: ",g.jsx(De,{children:h()})]}),g.jsxs(Oe,{children:["Weight: ",g.jsx(De,{children:e})]})]})]})]}),t&&g.jsx(Gr,{onClose:o,title:l,calories:a,id:s})]})}function Kr({products:n,isFetching:t}){return g.jsx(ar,{className:"custom-list",children:n.length===0&&!t?g.jsxs(ur,{children:[g.jsxs(pt,{children:[g.jsx(ft,{children:"Sorry, no results were found "}),"for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),g.jsx(pt,{children:g.jsx(ft,{children:"Try changing the search parameters."})})]}):n.map(i=>g.jsx(qr,{productItem:i},i._id))})}const Xr="/project-daily-energy-dose/assets/side-view-people-training-gym-071babdb.jpg",Zr="/project-daily-energy-dose/assets/side-view-people-training-gym@max-9cb7ca4d.jpg",Jr=[{id:"fdg12sdgdfdffsfd",value:"all",label:"All"},{id:"fdg12234sdfsdgsfd",value:"recommended",label:"Recommended"},{id:"fdg12asdf123gdfsdgsfd",value:"not-recommended",label:"Not recommended"}];function na(){on(E=>E.auth.token);const[n,t]=p.useState(""),[i,o]=p.useState(""),[e,a]=p.useState(""),[u,l]=p.useState(1),[r,s]=p.useState(!1),[c,d]=p.useState(0),[h,m]=p.useState([]),[v,b]=p.useState([]);p.useEffect(()=>{const E=document.querySelector(".custom-list");return E.addEventListener("scroll",f),function(){E.removeEventListener("scroll",f)}},[c,h]),p.useEffect(()=>{rn().then(F=>{b(F.data)}),Ne({params:{page:u,category:n,groupBloodNotAllowed:i,search:e}}).then(({data:F})=>{m(F.data),d(F.total),l(2)})},[]),p.useEffect(()=>{r&&Ne({params:{page:u,category:n,groupBloodNotAllowed:i,search:e}}).then(({data:F})=>{m([...h,...F.data]),d(F.total),l(C=>C+1)}).finally(()=>s(!1))},[r]);const f=E=>{E.target.scrollHeight-(E.target.scrollTop+window.innerHeight)<600&&h.length<c&&s(!0)},x=E=>{m([]),t(E.category),o(E.groupBloodNotAllowed),a(E.search),l(1),s(!0),d(0)};return g.jsx(fn,{bgi:[Xr,Zr],children:g.jsxs("div",{className:"container",children:[g.jsxs(mn,{children:[g.jsx(hn,{children:"Products"}),g.jsx(rr,{setParams:x,initialCategory:v,initialRecommended:Jr})]}),g.jsx(Kr,{products:h,isFetching:r})]})})}export{na as default};
